...
export async function importSigningKey(publicKey: JsonWebKey, keyUsages: KeyUsage[]): Promise<CryptoKey> {
	return crypto.subtle.importKey(
		"jwk",
		publicKey,
		{
...
export async function importSigningKeyPair(publicKey: JsonWebKey, privateKey: JsonWebKey): Promise<CryptoKeyPair> {
	return {
